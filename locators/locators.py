class PageLocators:
    ...
    NAME_INPUT_REGISTER = "//fieldset[1]//input"  # user name at register
    ...
    LOGIN_ENTER_BUTTON = "//button[text() = 'Войти']"  # login button
    ...
    INGREDIENTS_BUTTON = '//*[@id="root"]/div/main/section[1]/div[1]/div[3]/span' # fillings button
